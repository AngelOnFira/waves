...
func _move_lights(delta):
	if (get_node("Lights/Path2D/LightPath1").get_offset() > 2500):
		get_node("Lights/Path2D/LightPath1").set_offset(0)
	else:
		get_node("Lights/Path2D/LightPath1").set_offset(get_node("Lights/Path2D/LightPath1").get_offset() + (100 * delta))
	#print(get_node("Lights/Path2D/LightPath1").get_offset())
